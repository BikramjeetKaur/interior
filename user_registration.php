...
<?php
 ...
 if(isset($_POST['click']))
 {
  ...
  $insert_query ="insert into user_registration_table(user_name,email,mobile_no,password) values ('$user_name','$email_id','$mobile_no','$password')";
...
?>
  ...
  <div class="container-fluid" style="margin-top:5rem;">
    <div class="row">
        <div class="col-md-4">
            <img class="img-fluid" src="images/interior_decoration_registration.jpg">
        </div>
        <div class="col-md-6">
         <form class="form" action="" method="post" >
          <h2 class="text-center">Registration Form</h2>
                <div class="input-box">
                    <label>Name</label>
                    <input required="" placeholder="Enter full name" name="username" type="text">
                </div>
                <div class="column">
                    <div class="input-box">
                      <label>Email</label>
                    ...
                    <div class="input-box">
                      ...
                      <input required="" placeholder="Enter Mobile nunber" name="mobileno" type="text">
                    </div>
                ...
                <p class=" mt-2">If You have account Just <a href="userlogin.php">Login</a></p>
