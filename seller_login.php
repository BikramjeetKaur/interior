<?php
 ...
 if(isset($_POST['click']))
 {
    ...
    if(!empty($_POST['user_name']) && !empty($_POST['password']))
    {
        ...
        $sql="SELECT * FROM seller_login WHERE username= '$get_username' AND password = '$get_password' ";
    ...
    <div class="row form-body d-flex justify-content-end align-items-center">
      <div class="col-md-6">
        <form action="" class="form_main" method="post">
          <p class="heading">Seller Login!</p>
          <div class="inputContainer">
            ...
            <input type="text" class="inputField" id="username" placeholder="Username" name="user_name">
          </div>
          ...
          <h6 ><a style="color:white;text-decoration:none;" href="#">Forget password</a></h6> 
           <h6><a href="seller_registration.php">Sign up?</a></h6>
           </div>
