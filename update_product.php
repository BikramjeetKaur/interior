...
if(isset($_POST['click']))
  ...
  // move_uploaded_file($file_tmp,$mypath);
    ...
    $sql="update product_table set ID=$id, category_name=' $category_name',product_Name='$product_name ',price=$price,image='$file_name',Description='$description' where ID =$id";
...
<!-- bg-dark -->
           ...
           <h1 class="display-6 text-center w-100">product_Table</h1>
